        ...
        <div class="relative flex items-center">
          ...
          >
            ...
            >
              ...
              <span class="absolute -mt-4 ml-2.5 rounded-full bg-error px-[0.35em] py-[0.15em] text-[0.6rem] font-bold leading-none text-white">
                1
              </span>
            </a>
          </div>
          ...
          <a
            ...
            href="#"
          >
            <span class="flex-no-shrink h-10 w-10 fill-current [&>svg]:w-5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
                class="flex-no-shrink h-5 w-5 fill-current"
              >
